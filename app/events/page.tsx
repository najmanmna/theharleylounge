...
import { ArrowUpRight, Users, Wifi, Layers } from "lucide-react";
...
function EventScene({ data, index }: { data: any, index: number }) {
      ...
      <div className="container mx-auto px-6 relative z-10 w-full">
        <div className={`flex flex-col md:flex-row gap-16 md:gap-32 items-center ${index % 2 === 1 ? 'md:flex-row-reverse' : ''}`}>
          ...
          <div className="w-full md:w-2/5 flex flex-col justify-center">
              ...
              <div>
                {/* 2. UPDATED LINK: Smart routing to contact page */}
                <Link 
                  href={`/contact?interest=${encodeURIComponent(data.category)}`}
                  className="group relative block text-center px-10 py-5 bg-transparent border border-[#eebb4d]/30 overflow-hidden w-full md:w-auto hover:border-[#eebb4d] transition-colors duration-500"
                >
